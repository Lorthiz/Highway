...
(function (global, factory) {
    ...
    var StateObject = /** @class */ (function () {
         ...
         *
         * @param stateDecl the services-supplied State Declaration
     ...
     * @module resolve
     */ /** for typedoc */
        // TODO: explicitly make this services configurable
    ...
    var Transition = /** @class */ (function () {
        ...
        Transition.prototype._changedParams = function () {
            ...
            // If services explicitly wants a reload
     ...
     * * `'/services/:id'` - Matches '/services/bob' or '/services/1234!!!' or even '/services/' but not '/services' or
     *   '/services/bob/details'. The second path segment will be captured as the parameter 'id'.
     * * `'/services/{id}'` - Same as the previous example, but using curly brace syntax.
     * * `'/services/{id:[^/]*}'` - Same as the previous example.
     * * `'/services/{id:[0-9a-fA-F]{1,8}}'` - Similar to the previous example, but only matches if the id
    ...
    var UrlMatcher = /** @class */ (function () {
         ...
         * #### Example:
         * ```js
         * new UrlMatcher('/services/{id}?q&r').exec('/services/bob', {
         *   x: '1', q: 'hello'
         * });
         ...
         * #### Example:
         * ```js
         * new UrlMatcher('/services/{id}?q').format({ id:'bob', q:'yes' });
         * // returns '/services/bob?q=yes'
         * ```
         *
    ...
    var updateUrl = function (transition) {
        ...
        // The services doesn't want the url to update (options.location === false)
    ...
    function ignoredHook(trans) {
        ...
        // The services clicked a link going back to the *current state* ('A')
        // However, there is also a pending transition in flight (to 'B')
        // Abort the transition to 'B' because the services now wants to be back at 'A'.
    ...
    var StateService = /** @class */ (function () {
        ...
        StateService.prototype.transitionTo = function (to, toParams, options) {
             ...
             * IGNORED, but the transitionTo() promise is resolved because from the services perspective
    ...
    var UrlRouterProvider = /** @class */ (function () {
         ...
         *   // otherwise will take care of routing the services to the
         *   // specified url
         ...
         * @param handler The path (or function that returns a path) that you want to redirect your services to.
     ...
     * The state's `userId` parameter value comes from each services's `services.id` property.
     * ```html
     * <li ng-repeat="services in users">
     *   <a ui-sref="users.detail({ userId: services.id })">{{ services.displayName }}</a>
     * </li>
     * ```
     *
     * Note:
     ...
     * #### Example:
     * ```html
     * <li ng-repeat="services in users" ui-sref-active="active">
     *   <a ui-sref="services.details({ userId: services.id })">{{ services.lastName }}</a>
     * </li>
     * ```
     *
     * ### Examples
     ...
     *     <a href ui-sref="app.services({services: 'bilbobaggins'})">@bilbobaggins</a>
     *   </li>
     * </ul>
     * ```
     *
     * When the app state is `app.services` (or any child state),
     * and contains the state parameter "services" with value "bilbobaggins",
     * the resulting HTML will appear as (note the 'active' class):
     *
     * ```html
     * <ul>
     *   <li ui-sref-active="active" class="item active">
     *     <a ui-sref="app.services({services: 'bilbobaggins'})" href="/users/bilbobaggins">@bilbobaggins</a>
     *   </li>
     * </ul>
     * ```
     *
     ...
     * ```js
     * $stateProvider.state('home', {
     *   template: '<my-component services="$resolve.services"></my-component>',
     *   resolve: {
     *     services: function(UserService) { return UserService.fetchUser(); }
     *   }
     * });
     * ```
     */
    ...
    function registerControllerCallbacks($q$$1, $transitions, controllerInstance, $scope, cfg) {
        ...
        if (isFunction(controllerInstance.uiCanExit)) {
            ...
            // If a services answered yes, but the transition was later redirected, don't also ask for the new redirect transition
